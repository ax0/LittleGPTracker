...
static FourCC _all[] = {
    ...
    I_CMD_FCUT, I_CMD_FLTR, I_CMD_FRES, I_CMD_GROV, I_CMD_HOP,  I_CMD_IQUE,
    I_CMD_IRTG, I_CMD_KILL, I_CMD_LEGA, I_CMD_LPOF, I_CMD_MDCC, I_CMD_MDPG,
    I_CMD_MVEL, I_CMD_PAN_, I_CMD_PFIN, I_CMD_PLOF, I_CMD_PTCH, I_CMD_RQUE,
    I_CMD_RTRG, I_CMD_STOP, I_CMD_TABL, I_CMD_TMPO, I_CMD_VOLM};
